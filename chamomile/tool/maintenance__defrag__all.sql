...
/****** Object:  Job [maintenance__defrag__all]    Script Date: 12/8/2018 3:58:10 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [maintenance]    Script Date: 12/8/2018 3:58:10 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'maintenance__defrag__all', 
		...
		@owner_login_name=N'deva4cb16261c-1\Admin4fb1ca0d7b', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDB] defragment]    Script Date: 12/8/2018 3:58:10 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDW] defragment]    Script Date: 12/8/2018 3:58:10 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DynamicsAxReportServer] defragment]    Script Date: 12/8/2018 3:58:10 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DynamicsAxReportServerTempDB] defragment and update statistics]    Script Date: 12/8/2018 3:58:10 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DYNAMICSXREFDB] defragment and update statistics]    Script Date: 12/8/2018 3:58:10 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[FinancialReportingDb] defragment and update statistics]    Script Date: 12/8/2018 3:58:10 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Occurs every day every 15 minute(s)', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
		...
		@schedule_uid=N'203eca56-a619-479f-b73f-844a34df85a5'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback

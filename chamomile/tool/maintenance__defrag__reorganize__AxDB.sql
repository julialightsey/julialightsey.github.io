...
/****** Object:  Job [maintenance__defrag__reorganize__AxDB]    Script Date: 2/21/2019 4:56:46 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [maintenance]    Script Date: 2/21/2019 4:56:46 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'maintenance__defrag__reorganize__AxDB', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDB] defragment and update statistics]    Script Date: 2/21/2019 4:56:46 PM ******/

...
/****** Object:  Job [maintenance__defrag__reorganize__all]    Script Date: 2/21/2019 4:29:58 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [maintenance]    Script Date: 2/21/2019 4:29:58 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'maintenance__defrag__reorganize__all', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Reorganizes all indexes in all databases', 
		@category_name=N'maintenance', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDW] defragment and update statistics]    Script Date: 2/21/2019 4:29:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'[AxDW] defragment and update statistics', 
		@step_id=1, 
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DynamicsAxReportServer] defragment and update statistics]    Script Date: 2/21/2019 4:29:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'[DynamicsAxReportServer] defragment and update statistics', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DynamicsAxReportServerTempDB] defragment and update statistics]    Script Date: 2/21/2019 4:29:58 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DYNAMICSXREFDB] defragment and update statistics]    Script Date: 2/21/2019 4:29:58 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[FinancialReportingDb] defragment and update statistics]    Script Date: 2/21/2019 4:29:58 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDB] defragment and update statistics]    Script Date: 2/21/2019 4:29:58 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'[AxDB] defragment and update statistics', 
		@step_id=6, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 

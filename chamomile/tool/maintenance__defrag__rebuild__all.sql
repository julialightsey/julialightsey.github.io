...
/****** Object:  Job [maintenance__defrag__rebuild__all]    Script Date: 2/21/2019 4:48:30 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [maintenance]    Script Date: 2/21/2019 4:48:30 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'maintenance__defrag__rebuild__all', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDW] defragment and update statistics]    Script Date: 2/21/2019 4:48:30 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DynamicsAxReportServer] defragment and update statistics]    Script Date: 2/21/2019 4:48:30 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DynamicsAxReportServerTempDB] defragment and update statistics]    Script Date: 2/21/2019 4:48:30 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[DYNAMICSXREFDB] defragment and update statistics]    Script Date: 2/21/2019 4:48:30 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[FinancialReportingDb] defragment and update statistics]    Script Date: 2/21/2019 4:48:31 PM ******/
...
', 
		...
		@flags=12
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [[AxDB] defragment and update statistics]    Script Date: 2/21/2019 4:48:31 PM ******/

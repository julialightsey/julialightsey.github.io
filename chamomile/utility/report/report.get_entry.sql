...
if object_id(N'[report].[get_entry]'
             , N'FN') is not null
  drop function [report].[get_entry];
...
/*
	...
	------------------------------------------------
	declare @schema [sysname] = N'report', @object [sysname] = N'get_entry';
	--
	-------------------------------------------------
...
*/
create function [report].[get_entry] (@id          [uniqueidentifier]
                                      , @category  [sysname]
                                      , @class     [sysname]
                                      , @type      [sysname]
                                      , @timestamp [datetime])
...
exec sys.sp_addextendedproperty
  @name = N'execute_as',
  @value = N'
	select [report].[get_entry] (N''category'', N''class'', N''type'');',
  @level0type = N'schema',
  @level0name = N'report',
  @level1type = N'function',
  @level1name = N'get_entry';

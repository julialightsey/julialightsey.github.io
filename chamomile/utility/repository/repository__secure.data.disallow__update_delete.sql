if object_id ('[repository__secure].[repository__secure__data__disallow__update_delete]', 'TR') is not null
  drop trigger [repository__secure].[repository__secure__data__disallow__update_delete];
...
*/
create trigger [repository__secure].[repository__secure__data__disallow__update_delete]
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'description', N'schema', N'repository__secure', N'table', N'data', N'trigger', N'repository__secure__data__disallow__update_delete'))
  exec sys.sp_dropextendedproperty @name         = N'description'
                                   ...
                                   , @level2name = N'repository__secure__data__disallow__update_delete';
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'revision_20140804', N'schema', N'repository__secure', N'table', N'data', N'trigger', N'repository__secure__data__disallow__update_delete'))
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'package_log', N'schema', N'repository__secure', N'table', N'data', N'trigger', N'repository__secure__data__disallow__update_delete'))
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'release_00.93.00', N'schema', N'repository__secure', N'table', N'data', N'trigger', N'repository__secure__data__disallow__update_delete'))

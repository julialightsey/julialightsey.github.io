...
if object_id ('[repository__secure].[repository__secure.immutable.disallow__overlapping_active_expire]'
              , 'TR') is not null
  drop trigger [repository__secure].[repository__secure.immutable.disallow__overlapping_active_expire];
...
*/
create trigger [repository__secure].[repository__secure.immutable.disallow__overlapping_active_expire]
          ...
          from   [inserted] as [inserted]
                 join [repository__secure].[immutable] as [immutable]
                   on [immutable].[source] = [inserted].[source]
                      ...
                      and [immutable].[type] = [inserted].[type]
                      and ( ( [inserted].[active] >= [immutable].[active]
                              and [immutable].[expire] is null )
                             or ( [inserted].[active] between [immutable].[active] and [immutable].[expire] )
                             or ( [inserted].[expire] between [immutable].[active] and [immutable].[expire] ) )) > 1
        begin
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'immutable'
                                          , N'trigger'
                                          , N'repository__secure.immutable.disallow__overlapping_active_expire'))
  exec sys.sp_dropextendedproperty
    ...
    @level2name = N'repository__secure.immutable.disallow__overlapping_active_expire';

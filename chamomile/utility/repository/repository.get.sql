...
if object_id(N'[repository].[get]', N'FN') is not null
...
/*
	...
	------------------------------------------------
	declare @schema [sysname] = N'repository', @object [sysname] = N'get';
	--
	-------------------------------------------------
...
*/
create function [repository].[get] (@id         [uniqueidentifier]
                                    , @source   [sysname]
                                    , @category [sysname]
                                    , @class    [sysname]
                                    , @type     [sysname]
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'description', N'schema', N'data', N'function', N'get', default, default))
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'revision_20140804', N'schema', N'data', N'function', N'get', default, default))
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'package_log', N'schema', N'data', N'function', N'get', default, default))
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'release_00.93.00', N'schema', N'data', N'function', N'get', default, default))
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'execute_as', N'schema', N'data', N'function', N'get', default, default))
...
exec sys.sp_addextendedproperty @name         = N'execute_as'
                                , @value      = N'
	select [repository].[get] (N''category'', N''class'', N''type'');'
                                , @level0type = N'schema'
                                , @level0name = N'repository'
                                , @level1type = N'function'
                                , @level1name = N'get';
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'description', N'schema', N'data', N'function', N'get', N'column', N'@category'))
  exec sys.sp_dropextendedproperty @name         = N'description'
                                   , @level0type = N'schema'
                                   , @level0name = N'repository'
                                   , @level1type = N'function'
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'description', N'schema', N'data', N'function', N'get', N'column', N'@class'))
  exec sys.sp_dropextendedproperty @name         = N'description'
                                   , @level0type = N'schema'
                                   , @level0name = N'repository'
                                   , @level1type = N'function'
...
------------------------------------------------- 
if exists (select *
           from   fn_listextendedproperty(N'description', N'schema', N'data', N'function', N'get', N'column', N'@type'))
  exec sys.sp_dropextendedproperty @name         = N'description'
                                   , @level0type = N'schema'
                                   , @level0name = N'repository'
                                   , @level1type = N'function'

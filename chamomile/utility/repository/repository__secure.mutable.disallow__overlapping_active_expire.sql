...
if object_id ('[repository__secure].[repository__secure.mutable.disallow__overlapping_active_expire]'
              , 'TR') is not null
  drop trigger [repository__secure].[repository__secure.mutable.disallow__overlapping_active_expire];
...
*/
create trigger [repository__secure].[repository__secure.mutable.disallow__overlapping_active_expire]
  ...
  begin
      ...
      if (select count(*)
          from   [inserted] as [inserted]
                 join [repository__secure].[mutable] as [mutable]
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'mutable'
                                          , N'trigger'
                                          , N'repository__secure.mutable.disallow__overlapping_active_expire'))
  exec sys.sp_dropextendedproperty
    ...
    @level2name = N'repository__secure.mutable.disallow__overlapping_active_expire';

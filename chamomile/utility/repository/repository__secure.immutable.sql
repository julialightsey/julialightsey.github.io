...
if object_id(N'[repository__secure].[immutable]'
             , N'U') is not null
  drop table [repository__secure].[immutable];
...
*/
create table [repository__secure].[immutable]
  (
     [id]            [uniqueidentifier] not null constraint [repository__secure.immutable.id.default] default (newsequentialid()),
          constraint [repository__secure.immutable.id.primary_key_clustered] primary key clustered ([id])
     , [source]      [sysname] not null constraint [repository__secure.immutable.source.check] check ([source] in (N'metadata', N'report', N'log'))
     , [category]    [sysname]
     , [class]       [sysname]
     , [type]        [sysname]
     , [entry]       [xml] not null
     , [description] [nvarchar](max) null
     , [active]      [datetime] not null constraint [repository__secure.immutable.active.default] default current_timestamp
     , [expire]      [datetime] null
     , [created]     [datetime] not null constraint [repository__secure.immutable.created.default] default current_timestamp
  );
...
------------------------------------------------- 
------------------------------------------------- 
if indexproperty (object_id('[repository__secure].[immutable]')
                  , 'repository__secure.immutable.category.class.type.index'
                  , 'IndexID') is not null
  drop index [repository__secure.immutable.category.class.type.index] on [repository__secure].[immutable];

go

create nonclustered index [repository__secure.immutable.category.class.type.index]
  on [repository__secure].[immutable]([category], [class], [type]);
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'immutable'
                                          , N'index'
                                          , N'repository__secure.immutable.category.class.type.index'))
  exec sys.sp_dropextendedproperty
    ...
    @level2type = N'index',
    @level2name = N'repository__secure.immutable.category.class.type.index';

go

exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'create nonclustered index [repository__secure.immutable.category.class.type.index] 
  on [repository__secure].[immutable]([category], [class], [type]);',
  @level0type = N'schema',
  @level0name = N'repository__secure',
  @level1type = N'table',
...
------------------------------------------------- 
if indexproperty (object_id('[repository__secure].[immutable]')
                  , 'repository__secure.immutable.entry.index'
                  , 'IndexID') is not null
  drop index [repository__secure.immutable.entry.index] on [repository__secure].[immutable];

go

create primary xml index [repository__secure.immutable.entry.index]
  on [repository__secure].[immutable] ([entry]);
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'immutable'
                                          , N'index'
                                          , N'repository__secure.immutable.entry.index'))
  exec sys.sp_dropextendedproperty
    @name = N'description',
    @level0type = N'schema',
    @level0name = N'repository__secure',
    ...
    @level1name = N'immutable',
    @level2type = N'index',
    @level2name = N'repository__secure.immutable.entry.index';

go

exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'create primary xml index [repository__secure.immutable.entry.index] on [repository__secure].[immutable] ([entry]);',
  @level0type = N'schema',
  @level0name = N'repository__secure',
  @level1type = N'table',
  @level1name = N'immutable',
...
exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'The [repository__secure].[immutable] repository contains objects which must meet the business rules as defined in the 

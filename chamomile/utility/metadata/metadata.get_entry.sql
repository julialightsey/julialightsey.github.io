...
if object_id(N'[metadata].[get_entry]'
             , N'FN') is not null
  drop function [metadata].[get_entry];
...
/*
	...
	------------------------------------------------
	declare @schema [sysname] = N'metadata', @object [sysname] = N'get_entry';
	--
	-------------------------------------------------
...
*/
create function [metadata].[get_entry] (@id          [uniqueidentifier]
                                        , @category  [sysname]
                                        , @class     [sysname]
                                        , @type      [sysname]
                                        , @timestamp [datetime])
...
exec sys.sp_addextendedproperty
  @name = N'execute_as',
  @value = N'
	select [metadata].[get_entry] (N''category'', N''class'', N''type'');',
  @level0type = N'schema',
  @level0name = N'metadata',
  @level1type = N'function',
  @level1name = N'get_entry';

...
if object_id(N'[metadata].[set]'
             , N'P') is not null
  drop procedure [metadata].[set];
...
/*
	...
	------------------------------------------------
	declare @schema [sysname] = N'metadata', @object [sysname] = N'set';
	--
	-------------------------------------------------
...
*/
create procedure [metadata].[set] @category      [sysname]
                                  , @class       [sysname]
                                  , @type        [sysname]
                                  , @value       [sysname] = null
                                  , @entry       [xml] = null
...
exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'Primary mutator method for [report_secure].[metadata].',
  @level0type = N'schema',
  @level0name = N'metadata',
  @level1type = N'procedure',
  @level1name = N'set'

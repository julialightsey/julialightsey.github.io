...
if exists (select [xml_collection_id]
           ...
           where  [xsc].name = 'xsc_test_suite'
                  and [xsc].[schema_id] = schema_id(N'chamomile'))
  drop xml schema collection [chamomile].[xsc_test_suite];

go

create xml schema collection [chamomile].[xsc_test_suite] as N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:chamomile="http://www.chamomilesql.com/" targetNamespace="http://www.chamomilesql.com/">
  <xsd:element name="test_suite">
    <xsd:complexType>
      <xsd:sequence>
        <xsd:element name="description" type="xsd:string" minOccurs="1" maxOccurs="1" />
        <xsd:element name="test_suite_detail" type="chamomile:any_complex_type" minOccurs="0" maxOccurs="unbounded" />
        <xsd:element name="test_stack" type="chamomile:any_complex_type" minOccurs="0" maxOccurs="unbounded" />
      </xsd:sequence>
...
go 
declare @test [xml]([chamomile].[xsc_test_suite]) = N'
	 <chamomile:test_suite xmlns:chamomile="http://www.chamomilesql.com/" name="[chamomile].[person_test].[get_age]" test_count="2" pass_count="2" timestamp="2018-06-24T15:50:19.3466667">
...
/*
    <test_suite name="[chamomile].[person_test].[get_age]" test_count="2" pass_count="2" timestamp="2018-06-24T15:50:19.3466667">
	 <description>This test stack consists of tests which validate the functionality of the age calculation for a person.</description>

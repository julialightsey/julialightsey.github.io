...
values      (N'rose',N'red',5),
            ...
            (N'lily',N'white',12);
insert into [flower].[order]
            ([flower],[color],[count],[persistent])
values      (N'rose',N'red',12,N'true'),
            (N'chamomile',N'amber',36,N'true');
--
select [id]
       , [flower]
       , [color]
...
select [index] - @separator_length as [index]
       , substring(@input
                   , [next_split_value]
                   , case
                         when [split_location] > 0
                             then
                           [split_location] - [next_split_value]
                         else
                           len(@input)
                     end)          as [node]
from   [splitter];
...
insert into [flower].[order]
            ([flower],[color],[count])
values      (N'rose',N'red',12),
            (N'marigold',N'yellow',24),
            (N'chamomile',N'amber',36),
            (N'lily',N'white',3);
--
select [flower]
       , [color]
...
--
insert into [flower].[order]
            ([flower],[color],[count],[scheduled])
values      (N'rose',N'red',12,current_timestamp),
            (N'marigold',N'yellow',24,current_timestamp),
            (N'chamomile',N'amber',36,current_timestamp),
            (N'lily',N'white',3,current_timestamp);
--
select [flower]
       , [color]
       , [count]

...
insert into [flower].[order]
            ([date],[flower],[color])
values      (N'20140101',N'tulip',N'red'),
            (N'20150101',N'rose',N'orange'),
            (N'20160606',N'tulip',N'white'),
            (N'20120101',N'tulip',N'green'),
            (N'20110101',N'rose',N'blue'),
            (N'20160101',N'rose',N'violet');

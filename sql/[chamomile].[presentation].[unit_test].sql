...
go
if schema_id(N'math_test') is null
  execute (N'create schema math_test');
go
if object_id(N'[test].[run]', N'P') is not null
  drop procedure [test].[run];
go
if object_id(N'[math_test].[divide]', N'P') is not null
  drop procedure [math_test].[divide];
go
-------------------------------------------------
-- code block end
--
...
/*
	...
	select [name]
           , [value]
    from   fn_listextendedproperty(N'execute_as', N'schema', N'math_test', N'procedure', N'divide', null, null);  
	...
	------------------------------------------------
*/
create procedure [math_test].[divide]
  @stack [xml] output
as
  begin
...
if exists
   (select *
    from   fn_listextendedproperty(N'execute_as', N'schema', N'math_test', N'procedure', N'divide', default, default))
  exec sys.sp_dropextendedproperty
    @name         = N'execute_as'
    , @level0type = N'schema'
    , @level0name = N'math_test'
...
exec sys.sp_addextendedproperty
  @name         = N'execute_as'
  , @value      = N'declare @stack [xml]; execute [math_test].[divide] @stack=@stack output; select @stack;'
  , @level0type = N'schema'
  , @level0name = N'math_test'
  , @level1type = N'procedure'
  , @level1name = N'divide'
...
--	[math_test].[divide_{test_name}] so that a normal ORDER BY 
...
--
-------------------------------------------------
if object_id(N'[math_test].[divide_using_decimal]', N'P') is not null
  drop procedure [math_test].[divide_using_decimal];
go
/*
	select [name]
           , [value]
    from   fn_listextendedproperty(N'execute_as', N'schema', N'math_test', N'procedure', N'divide_using_decimal', null, null);  
*/
create procedure [math_test].[divide_using_decimal]
  @stack [xml] output
as
  begin
      declare @test_stack       [xml] = N'<test_stack fqn="" test_count="0" error_count="0" pass_count="0" />'
...
if exists
   (select *
    from   fn_listextendedproperty(N'execute_as', N'schema', N'math_test', N'procedure', N'divide_using_decimal', default, default))
  exec sys.sp_dropextendedproperty
    @name         = N'execute_as'
    , @level0type = N'schema'
    , @level0name = N'math_test'
...
exec sys.sp_addextendedproperty
  @name         = N'execute_as'
  , @value      = N'declare @stack [xml]; execute [math_test].[divide_using_decimal] @stack=@stack output; select @stack;'
  , @level0type = N'schema'
  , @level0name = N'math_test'
  , @level1type = N'procedure'
  , @level1name = N'divide_using_decimal'
...
-------------------------------------------------
declare @stack [xml];
execute [math_test].[divide_using_decimal]
  @stack=@stack output;
select @stack;
go
-------------------------------------------------
...
-------------------------------------------------
if object_id(N'[math_test].[run]', N'P') is not null
  drop procedure [math_test].[run];
go
/*
	select [name]
           , [value]
    from   fn_listextendedproperty(N'execute_as', N'schema', N'math_test', N'procedure', N'run', null, null);  
*/
create procedure [math_test].[run]
  @stack [xml] output
as
  begin
...
if exists
   (select *
    from   fn_listextendedproperty(N'execute_as', N'schema', N'math_test', N'procedure', N'run', default, default))
  exec sys.sp_dropextendedproperty
    @name         = N'execute_as'
    , @level0type = N'schema'
    , @level0name = N'math_test'
...
exec sys.sp_addextendedproperty
  @name         = N'execute_as'
  , @value      = N'declare @stack [xml]; execute [math_test].[run] @stack=@stack output; select @stack;'
  , @level0type = N'schema'
  , @level0name = N'math_test'
  , @level1type = N'procedure'
  , @level1name = N'run'
...
as
  begin
      ...
      declare test_list cursor for
        select N'[math_test].[' + [name] + N']'
        from   [sys].[procedures]
        where  object_schema_name([object_id]) = N'math_test'
...
-- code block begin
-------------------------------------------------
if object_id(N'[math_test].[set]', N'P') is not null
  drop procedure [math_test].[set];
go
create procedure [math_test].[set]

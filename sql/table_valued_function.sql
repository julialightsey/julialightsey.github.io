...
--
-------------------------------------------------
if object_id(N'[kate_test].[table_valued_function]', N'TF') is not null
...
go 
if object_id(N'[kate_test].[sample_01]', N'U') is not null drop table [kate_test].[sample_01];
go
create table [kate_test].[sample_01] ([id] [int] identity(1,1) not null, [color] [sysname]);
go
--
-------------------------------------------------
select [name]

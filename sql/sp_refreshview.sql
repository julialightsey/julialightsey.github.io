...
-- create sample table
-------------------------------------------------
if object_id(N'kate_secure.sample_01', N'U') is not null
...
-------------------------------------------------
if object_id(N'kate.sample_01', N'V') is not null
	drop view kate.sample_01;
go
create view kate.sample_01 as
	select * from kate_secure.sample_01;
go

select null as 'only two columns expected', * from kate.sample_01;
go
...
select null as 'three columns expected but only two as result!', * from kate.sample_01;
go

select null as 'but see, the extra column did get added to the table', * from kate_secure.sample_01;
go

execute dbo.sp_refreshview N'kate.sample_01';
go

select null as 'correct column list from view after using dbo.sp_refreshview', * from kate.sample_01;
go
